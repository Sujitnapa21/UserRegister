...
func (e TitleEdges) UserOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.User, nil
	}
...
// QueryUser queries the user edge of the Title.
func (t *Title) QueryUser() *UserQuery {
	return (&TitleClient{config: t.config}).QueryUser(t)
}
